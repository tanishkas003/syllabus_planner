...
def chat_completion(system_prompt: str, user_prompt: str, temperature=0.2, max_tokens=800):
    messages = [
...
DECOMPOSE_SYSTEM = "You are an expert instructional designer. Break topics into smaller study units."
DECOMPOSE_USER = ("Input topic: {topic}\nContext: {context}\n"
